...
| [GoRest.in](https://www.gorest.in/) | Public QA CRUD users; manual disposable-user validation for OpenAPI-inferred INSERT/GET/PATCH/PUT/DELETE, bearer auth, filtered identity recovery, and cleanup |
